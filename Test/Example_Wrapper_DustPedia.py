...
target_gals = ['NGC4030','NGC5584','NGC5705','UGC09299']#['NGC4030','NGC4559','NGC5496','NGC5584','NGC5658','NGC5690','NGC5691','NGC5705','NGC5719','NGC5740','NGC5746','NGC5750','UGC04684','UGC06879''UGC07396','UGC09299','UGC09470','UGC09482']
...
# State what dust mass absorption coefficient we'll be using (and at what reference wavelenght we'll be defining it)
kappa_0 = 0.051
...
for g in np.random.permutation(cat_frame.index):
    ...
    posterior = ChrisFit.Fit(gal_dict,
                             ...
                             mcmc_n_threads = int(round(mp.cpu_count()*1.0))-1,
                             mcmc_n_walkers = 1000,
                             mcmc_n_steps = 2000,
                             plot = out_dir,
                             simple_clean = 0.75)
